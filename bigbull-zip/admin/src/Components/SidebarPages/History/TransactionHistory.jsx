...
const TransactionHistory = () => {
  ...
  return (
    <section className='p-10'>
      ...
      <div className=' mt-10'>
        <p className='text-primary font-medium mx-4 my-2 '>Transaction History</p>
        <div className='card'>
          {/* header */}
            ...
            <table className='w-full '>
              <thead >
                <tr className='bg-black '>
                  ...
                  <th className='py-4 px-3 font-semibold text-[13px] text-center whitespace-nowrap'>BANK NAME</th>
                  <th className='py-4 px-3 font-semibold text-[13px] text-center whitespace-nowrap'>NUMBER </th>
                  ...
                  [...Array(6)].map((item, index) => {
                    return (
                      <tr key={index} className='border-b'>
                        ...
                        <td className='text-center px-5 whitespace-nowrap text-sm font-medium py-4 '>UBL</td>
                        <td className='text-center px-5 whitespace-nowrap text-sm font-medium py-4 '>1234567890</td>
